                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <a href="peminjaman_detail_edit.php?id_peminjaman_detail=<?= $pd["id_peminjaman_detail"] ?>"
                                                        class="btn btn-info text-white"><i class="mdi mdi-pencil"></i></a>
                                                    <a href="peminjaman_detail_delete.php?id_peminjaman_detail=<?= $pd["id_peminjaman_detail"] ?>"
