    ...
    if (isset($_SESSION['cart'][$id])) {
        ...
        if (mysqli_num_rows($query_s) != 0) {
            ...
            $_SESSION['cart'][$row_s['id_alat_bahan']] = array(
                "nama_alat_bahan" => $row_s['nama_alat_bahan'],
                "id_alat_bahan" => $row_s['id_alat_bahan'],
                "quantity" => 1
            );
        } else {
        ...
        <div class="card">
            <div class="el-card-item">
                ...
                <div class="el-card-content text-center">
                    ...
                    <a href="user_peminjaman_detail_add.php?page=products&action=add&id=<?= $ab["id_alat_bahan"]; ?>&id_peminjaman=<?= $id_peminjaman ?>"
